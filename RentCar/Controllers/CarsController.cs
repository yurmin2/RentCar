...
namespace RentCar.Controllers
{
    public class CarsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CarModel,ReleaseDate,TransmissionType,RentalPrice")] Car car)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CarModel,ReleaseDate,TransmissionType,RentalPrice")] Car car)
        {
            if (id != car.Id)
            {
                return NotFound();
